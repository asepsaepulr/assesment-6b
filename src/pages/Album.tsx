  ...
  return(
    <>
      <div className="grid gap-4 max-w-7xl mx-auto w-full">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-l from-orange-500 to-orange-800"></div>
          <div
            className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center p-6 lg:p-10 space-y-4 lg:space-y-0 lg:space-x-8">
            {/* Album Cover */}
            <div className="w-36 h-36 lg:w-36 lg:h-36 flex-shrink-0 rounded-md overflow-hidden shadow-lg">
              <Image
            ...
            <div>
              ...
              <h2 className="text-2xl md:text-3xl lg:text-5xl font-extrabold">Parachutes</h2>
              <p className="mt-2 text-neutral-200 text-sm lg:text-base">
                <span className="text-blue-400">Coldplay</span> • 2000 • 10 songs, 41 min 55 sec
              </p>
            </div>
          </div>
        </WobbleCard>
      ...
      {/*card discography*/}
      <ul className="max-w-6xl mx-auto w-full md:grid-cols-6 grid gap-4">
        {cards.map((card) => (
          <motion.div
            layoutId={`card-${card.title}-${id}`}
            key={card.title}
